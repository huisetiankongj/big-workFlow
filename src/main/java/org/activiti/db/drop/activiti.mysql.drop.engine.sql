drop index ACT_IDX_EXEC_BUSKEY on ${prefix}ACT_RU_EXECUTION;
drop index ACT_IDX_TASK_CREATE on ${prefix}ACT_RU_TASK;
drop index ACT_IDX_IDENT_LNK_USER on ${prefix}ACT_RU_IDENTITYLINK;
drop index ACT_IDX_IDENT_LNK_GROUP on ${prefix}ACT_RU_IDENTITYLINK;
drop index ACT_IDX_VARIABLE_TASK_ID on ${prefix}ACT_RU_VARIABLE;
drop index ACT_IDX_INFO_PROCDEF on ${prefix}ACT_PROCDEF_INFO;
...
drop index ACT_IDX_ATHRZ_PROCEDEF on ${prefix}ACT_RU_IDENTITYLINK;
drop index ACT_IDX_EVENT_SUBSCR_CONFIG_ on ${prefix}ACT_RU_EVENT_SUBSCR;
...
drop table if exists ${prefix}ACT_RE_MODEL;
...
drop table if exists ${prefix}ACT_EVT_LOG;
drop table if exists ${prefix}ACT_PROCDEF_INFO;