...
create table ${prefix}ACT_RE_MODEL (
...
create table ${prefix}ACT_EVT_LOG (
...
create table ${prefix}ACT_PROCDEF_INFO (
	ID_ varchar(64) not null,
...
create index ACT_IDX_EXEC_BUSKEY on ${prefix}ACT_RU_EXECUTION(BUSINESS_KEY_);
create index ACT_IDX_TASK_CREATE on ${prefix}ACT_RU_TASK(CREATE_TIME_);
create index ACT_IDX_IDENT_LNK_USER on ${prefix}ACT_RU_IDENTITYLINK(USER_ID_);
create index ACT_IDX_IDENT_LNK_GROUP on ${prefix}ACT_RU_IDENTITYLINK(GROUP_ID_);
create index ACT_IDX_EVENT_SUBSCR_CONFIG_ on ${prefix}ACT_RU_EVENT_SUBSCR(CONFIGURATION_);
create index ACT_IDX_VARIABLE_TASK_ID on ${prefix}ACT_RU_VARIABLE(TASK_ID_);
create index ACT_IDX_ATHRZ_PROCEDEF on ${prefix}ACT_RU_IDENTITYLINK(PROC_DEF_ID_);
create index ACT_IDX_INFO_PROCDEF on ${prefix}ACT_PROCDEF_INFO(PROC_DEF_ID_);
...
alter table ${prefix}ACT_RE_PROCDEF
...
alter table ${prefix}ACT_RE_MODEL 
...
alter table ${prefix}ACT_PROCDEF_INFO 
