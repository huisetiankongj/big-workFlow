package com.it313.big.modules.act.service.ext;
...
import com.it313.big.modules.sys.service.SystemService;
...
//		}
	/*	User user = findUserById(userId);
		if (user != null) {
			getSystemService().deleteUser(new com.it313.big.modules.sys.entity.User(user.getId()));
		}*/
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.it313.big.modules.sys.entity.User(null, userId)))){
